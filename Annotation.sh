...
#Pfam database: download at https://ftp.ebi.ac.uk/pub/databases/Pfam/current_release/Pfam-A.hmm.gz and unzip by wget command
#Run Hmmerpress: "hmmpress Pfam-A.hmm/Pfam-A.hmm"
